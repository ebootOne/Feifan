...
extern "C" {
    JNIEXPORT void JNICALL Java_com_main_feifan_config_JNIHelper_trojan(JNIEnv *env, jclass, jstring config) {
    ...
    JNIEXPORT void JNICALL Java_com_main_feifan_config_JNIHelper_stop(JNIEnv *env, jclass) {

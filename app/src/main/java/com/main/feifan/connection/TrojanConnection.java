package com.main.feifan.connection;
...
/**
 * A class that delegates interaction with {@link com.main.feifan.ProxyService}. You should call {@link #connect(Context, Callback)}

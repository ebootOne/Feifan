...
import com.main.feifan.config.ClashHelper;
import com.main.feifan.config.Globals;
import com.main.feifan.config.JNIHelper;
...
import com.main.feifan.connection.TestConnection;
import com.main.feifan.setting.data.SettingsDataManager;
import com.main.feifan.utils.PreferenceUtils;
import com.main.x_base.exempt.data.ExemptAppDataManager;
import com.main.x_base.exempt.data.ExemptAppDataSource;
 ...
 * of {@link com.main.feifan.tile.ProxyHelper}.
 * <br/>
 ...
 * {@link com.main.feifan.connection.TrojanConnection}. For further information, see
 * {@link com.main.feifan.connection.TrojanConnection}.
 */
public class ProxyService extends VpnService implements TestConnection.OnResultListener {
     ...
     */
    private void applyApplicationOrientedRule(Builder builder) {
    ...
    interface RuleApplier {
        void applyRule(Builder builder, String packageName) throws PackageManager.NameNotFoundException;
    }

    private void addExtraDNS(Builder b, SettingsDataManager dataManager) {
